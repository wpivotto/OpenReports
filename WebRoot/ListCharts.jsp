...
<div align="center">
  ...
  <display:table name="reportCharts"  class="displaytag" cellspacing="1"  sort="list" requestURI="listCharts.action" decorator="org.efs.openreports.util.HRefColumnDecorator">      
