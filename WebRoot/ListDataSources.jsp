...
<div align="center">
  ...
  <display:table name="dataSourceNames"  class="displaytag" cellspacing="1"  sort="list" requestURI="listDataSources.action" decorator="org.efs.openreports.util.HRefColumnDecorator">  	      
