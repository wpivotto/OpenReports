...
<div align="center">
  ...
  <display:table name="reportGroups"  class="displaytag" cellspacing="1"  sort="list" requestURI="listGroups.action" decorator="org.efs.openreports.util.HRefColumnDecorator"> 	      
