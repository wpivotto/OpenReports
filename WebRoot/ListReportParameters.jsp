...
<div align="center">
  ...
  <display:table name="reportParameters"  class="displaytag" cellspacing="1"  sort="list"  requestURI="listReportParameters.action" decorator="org.efs.openreports.util.HRefColumnDecorator">  	      
