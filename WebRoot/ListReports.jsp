...
<div align="center">
  ...
  <display:table name="reports"  class="displaytag" cellspacing="1"  sort="list" requestURI="listReports.action" decorator="org.efs.openreports.util.HRefColumnDecorator">  	   	      
