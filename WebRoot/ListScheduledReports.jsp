...
<div align="center">
  ...
  <display:table name="scheduledReports"  class="displaytag" cellspacing="1"  sort="list" decorator="org.efs.openreports.util.HRefColumnDecorator" requestURI="listScheduledReports.action" >         
    ...
    <display:column property="startDateTime" titleKey="label.startDate" sortable="true" headerClass="sortable" format="{0,date,dd/MM/yyyy H:mm}"/>   
    <display:column property="scheduleTypeName" titleKey="label.scheduleType" sortable="true" headerClass="sortable"/>	     	      	       	     	      
    <display:column property="nextFireDate" titleKey="label.nextRun" sortable="true" headerClass="sortable" format="{0,date,dd/MM/yyyy H:mm:ss}"/>    	     	      	       	     	         
