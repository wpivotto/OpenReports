...
<@display.table name="results" class="displaytag" sort="list" export=true pagesize=200 requestURI="queryReportResult.action" cellspacing="1"> 
  ...
  <@display.column property="anomalia" title="Anomalia"/> 

  <@display.column property="causa" title="Causa"/> 

  <@display.column property="acao" title="Acao"/> 

  <@display.column property="valor" title="Temperatura" format="{0,number,#,##0.0}"/> 
